...
public class EmployeeView implements Initializable {
    ...
    @FXML
    private TableColumn<ModelTable2, String> ID;
    @FXML
    private TableColumn<ModelTable2, String> Name;
    @FXML
    private TableColumn<ModelTable2, String> DOB;
    @FXML
    private TableColumn<ModelTable2, String> Contact;
    @FXML
    private TableColumn<ModelTable2, String> Description;

    //Declaring an ArrayList
    ObservableList<ModelTable2> ArrayList = FXCollections.observableArrayList();
    ...
    public void back(ActionEvent actionEvent) throws IOException {
        ...
        primaryStage.setTitle("Employee View Menu");
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        try {
            ...
            while (rs.next()) {
                ArrayList.add(new ModelTable2(rs.getString("employeeID"), rs.getString("employeeName"), rs.getString("employeeDOB"), rs.getString("employeeContactNumber"), rs.getString("roleDescription")));
            }
